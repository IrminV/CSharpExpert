...
using Yayen.Assignment4.Framework.Vizualization;
using Yayen.Assignment4.Gameplay.Scenes;

namespace Yayen.Assignment4.Framework.MonoGameBase
{
    /// <summary>
    /// MonoGame Game1.
    /// </summary>
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            FireMageAnimTest fireMageAnimTest = new(_sceneSystem, Content, this, "FireMageAnimTest");
            MegamanAnimTest megamanAnimTest = new(_sceneSystem, Content, this, "MegamanAnimTest");
            ...
            _sceneSystem.AddScene(fireMageAnimTest);
            _sceneSystem.AddScene(megamanAnimTest);
