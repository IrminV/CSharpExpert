...
namespace Yayen.Assignment4.Gameplay.Scenes
{
    public class BouncerTest : Scene
    {
        ...
        public override void LoadContent(ContentManager pContent, Game1 pGame1)
        {
            ...
            newGameObject2.AddComponent(new Text(pContent.Load<SpriteFont>("DefaultSpritefont"), "To Sine Rotation Test"));
            newGameObject2.AddComponent(new Button());
            newGameObject2.AddComponent(new ButtonSceneSwitchScript( _sceneSystem, "SineRotationTest"));
            ...
            obj1.AddComponent(new Text(pContent.Load<SpriteFont>("DefaultSpritefont"), "Obj 1 Bouncer\nDirection (-0.5, 1)\nAmplitude: 32", 0, 64));
            obj1.AddComponent(new Bouncer(1f, 32, new Vector2(-0.5f, 1)));
            ...
            obj2.AddComponent(new Text(pContent.Load<SpriteFont>("DefaultSpritefont"), "Obj 2 Bouncer\nDirection (0.5, 1)\nAmplitude: 32", 0, 64));
            obj2.AddComponent(new Bouncer(1f, 32, new Vector2(0.5f, 1)));
            ...
            obj3.AddComponent(new Text(pContent.Load<SpriteFont>("DefaultSpritefont"), "Obj 3 Bouncer\nPeriodsPerSecond: 0.8357", 0, 64));
            obj3.AddComponent(new Bouncer(0.8357f, 32));
            ...
            obj4.AddComponent(new Text(pContent.Load<SpriteFont>("DefaultSpritefont"), "Obj 4 Bouncer\nDirection (-0.5, 1)\nAmplitude: 16", 0, 64));
            obj4.AddComponent(new Bouncer(1f, 16, new Vector2(-0.5f, 1)));
            ...
            obj5.AddComponent(new Text(pContent.Load<SpriteFont>("DefaultSpritefont"), "Obj 5 Bouncer\nDirection (-1, 0)\nAmplitude: 60", 0, 64));
            obj5.AddComponent(new Bouncer(1f, 60, new Vector2(-1f, 0)));
            ...
            obj6.AddComponent(new Text(pContent.Load<SpriteFont>("DefaultSpritefont"), "Obj 6 Bouncer\nDirection (69.696969, 0)\nAmplitude: 60", 0, 64));
            obj6.AddComponent(new Bouncer(1f, 60, new Vector2(69.696969f, 0)));
            ...
            obj7.AddComponent(new Text(pContent.Load<SpriteFont>("DefaultSpritefont"), "Obj 7 Bouncer\nPeriodsPerSecond: 2", 0, 64));
            obj7.AddComponent(new Bouncer(2f, 32));
