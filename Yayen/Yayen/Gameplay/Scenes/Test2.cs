...
namespace Yayen.Gameplay.Scenes
{
    public class Test2 : Scene
    {
        ...
        public override void LoadContent(ContentManager pContent, Game1 pGame1)
        {
            ...
            newGameObject.AddComponent(new Text(newGameObject, pContent.Load<SpriteFont>("DefaultSpritefont"), "Test3"));
            ...
            obj1.AddComponent(new Text(obj1, pContent.Load<SpriteFont>("DefaultSpritefont"), "Obj 1 Position: 0, 0", 0, 64));
            _GameObjects.Add(obj1);

            GameObject obj2 = new(this, "Obj2", 32, 32, 0, 0.5f, 0.5f);
            ...
            obj2.AddComponent(new Text(obj2, pContent.Load<SpriteFont>("DefaultSpritefont"), "Obj 2 Position: 32, 32", 0, 64));
            _GameObjects.Add(obj2);

            GameObject obj3 = new(this, "Obj3", 288, 32, 0, 0.5f, 0.5f);
            ...
            obj3.AddComponent(new Text(obj3, pContent.Load<SpriteFont>("DefaultSpritefont"), "Obj 3 Position: 288, 32", 0, 64));
            ...
            obj4.AddComponent(new Text(obj4, pContent.Load<SpriteFont>("DefaultSpritefont"), "Obj 4 Position:\nMidpoint + 96 by 96", 0, 64));
