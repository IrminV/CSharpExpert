...
namespace Yayen.Assignment3.Gameplay.Scenes
{
    public class ColorShifterTest: Scene
    {
        ...
        public override void LoadContent(ContentManager pContent, Game1 pGame1)
        {
            ...
            newGameObject.AddComponent(new Text(pContent.Load<SpriteFont>("DefaultSpritefont"), "To MixTest"));
            newGameObject.AddComponent(new Button());
            newGameObject.AddComponent(new ButtonSceneSwitchScript(_sceneSystem, "MixTest"));
            ...
            newGameObject2.AddComponent(new ButtonSceneSwitchScript(_sceneSystem, "ScalerTest"));
            ...
            SceneDescription.AddComponent(new Text(pContent.Load<SpriteFont>("DefaultSpritefont"), "ColorShifter Test", 0, 0));
