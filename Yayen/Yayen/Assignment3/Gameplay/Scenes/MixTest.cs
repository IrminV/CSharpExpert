...
namespace Yayen.Assignment3.Gameplay.Scenes
{
    public class MixTest: Scene
    {
        ...
        public override void LoadContent(ContentManager pContent, Game1 pGame1)
        {
            ...
            obj9.AddComponent(new Text(pContent.Load<SpriteFont>("DefaultSpritefont"), "Obj 7", 0, 64));
            ...
            obj10.AddComponent(new Text(pContent.Load<SpriteFont>("DefaultSpritefont"), "Obj 8", 0, 64));
