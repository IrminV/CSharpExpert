...
namespace Yayen.Assignment3.Gameplay.Scenes
{
    public class RotationTest : Scene
    {
        ...
        public override void LoadContent(ContentManager pContent, Game1 pGame1)
        {
            ...
            newGameObject.AddComponent(new Text(pContent.Load<SpriteFont>("DefaultSpritefont"), "To Position Test"));
            newGameObject.AddComponent(new Button());
            newGameObject.AddComponent(new ButtonSceneSwitchScript(_sceneSystem, "PositionTest"));
            ...
            SceneDescription.AddComponent(new Text(pContent.Load<SpriteFont>("DefaultSpritefont"), "Rotation Test", 0, 0));
            ...
            obj1.AddComponent(new Text(pContent.Load<SpriteFont>("DefaultSpritefont"), "Obj 1 Rotation: 0", 0, 64));
            _GameObjects.Add(obj1);

            GameObject obj2 = new(this, "Obj2", _graphicsDevice.Viewport.Width / 2 - 96, 224, 90, 0.5f, 0.5f);
            ...
            obj2.AddComponent(new Text(pContent.Load<SpriteFont>("DefaultSpritefont"), "Obj 2 Rotation: 90", 0, 64));
            _GameObjects.Add(obj2);

            GameObject obj3 = new(this, "Obj3", _graphicsDevice.Viewport.Width / 2 - 96, 352, 180, 0.5f, 0.5f);
            ...
            obj3.AddComponent(new Text(pContent.Load<SpriteFont>("DefaultSpritefont"), "Obj 3 Rotation: 180", 0, 64));
            _GameObjects.Add(obj3);

            GameObject obj4 = new(this, "Obj4", _graphicsDevice.Viewport.Width / 2 + 96, 96, 270, 0.5f, 0.5f);
            ...
            obj4.AddComponent(new Text(pContent.Load<SpriteFont>("DefaultSpritefont"), "Obj 4 Rotation: 270", 0, 64));
            ...
            obj5.AddComponent(new Text(pContent.Load<SpriteFont>("DefaultSpritefont"), "Obj 5 Rotation: -90", 0, 64));
            ...
            obj6.AddComponent(new Text(pContent.Load<SpriteFont>("DefaultSpritefont"), "Obj 6 Rotation: 360", 0, 64));
            ...
            obj7.AddComponent(new Text(pContent.Load<SpriteFont>("DefaultSpritefont"), "Obj 7 Rotation: 450", 0, 64));
