...
namespace Yayen.Assignment3.Gameplay.Scenes
{
    public class RotationTest : Scene
    {
        ...
        public override void LoadContent(ContentManager pContent, Game1 pGame1)
        {
            ...
            newGameObject2.AddComponent(new Text(newGameObject2, pContent.Load<SpriteFont>("DefaultSpritefont"), "To ColorShifter Test"));
            newGameObject2.AddComponent(new Button(newGameObject2));
            newGameObject2.AddComponent(new ButtonSceneSwitchScript(newGameObject2, _sceneSystem, "ColorShifterTest"));
            ...
            obj1.AddComponent(new Text(obj1, pContent.Load<SpriteFont>("DefaultSpritefont"), "Obj 1 Rotation: 0", 0, 64));
