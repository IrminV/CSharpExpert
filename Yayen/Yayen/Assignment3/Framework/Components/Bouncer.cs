...
namespace Yayen.Assignment3.Framework.Components
{
    public class Bouncer : Component
    {
        ...
        protected Vector2 AddedPosition = Vector2.Zero;
        ...
        private void UpdateBouncePosition()
        {
            ...
            if (_bounceActive)
            {
                ...
                //{
                //    _transform.Position = new Vector2(_bounceAnchor.X + (AddedPosition.X + _sineWave.SineValue * _bounceDirection.X), _bounceAnchor.Y + (AddedPosition.Y + _sineWave.SineValue * _bounceDirection.Y));
                //}
                //else
                //{
                //    _nextBouncer.AddedPosition = AddedPosition += new Vector2(_sineWave.SineValue * _bounceDirection.X, _sineWave.SineValue * _bounceDirection.Y);
                //}
            }
